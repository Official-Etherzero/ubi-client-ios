...
- (instancetype)initWithOrderModel:(OrderModel *)model {
    if (self = [super init]) {
        ...
        YYLabel *titleView = [[YYLabel alloc] initWithFont:FONT_PingFangSC_Heavy_36 textColor:COLOR_ffffff text:YYStringWithKey(@"等待卖方确认")];
        ...
        YYLabel *paymentView = [[YYLabel alloc] initWithFont:FONT_DESIGN_24 textColor:COLOR_ffffff text:@"USDT(ETH)"];
