...
- (int32_t)setOperationWithSentinel:(int32_t)sentinel
                                url:(NSURL *)imageURL
                        customBlock:(EVOWebImageCustomeRequest)customeRequest
                            options:(YYWebImageOptions)options
                            manager:(YYWebImageManager *)manager
                           progress:(YYWebImageProgressBlock)progress
                          transform:(YYWebImageTransformBlock)transform
    ...
    NSOperation *operation = [manager requestImageWithURL:imageURL customBlock:customeRequest options:EVOWebImageOptionFromRTMP progress:progress transform:transform completion:completion];
