...
#define kTAG "CSStickyHeaderFlowLayout"
...
- (CGSize)collectionViewContentSize {
    ...
    //waring!!! no one know why size.height small then collectionView height that boom doesnot work
    CGFloat collectionViewHeight = self.collectionView.frame.size.height;
    if (size.height < collectionViewHeight) {
        size.height = collectionViewHeight + 20;
    }
    return size;
}
